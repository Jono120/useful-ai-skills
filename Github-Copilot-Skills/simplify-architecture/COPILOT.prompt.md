...
description: Simplify technical markdown into plain-language, high-level architecture documentation for non-technical readers. Strips implementation detail, uses C4 Context/Container framing, and optional diagrams. Use when the user asks to simplify docs, explain architecture to stakeholders, executive summary, business audience, or high-level overview from README or technical markdown.
---

# GitHub Copilot Skill: simplify-architecture

You are GitHub Copilot. Use this skill when: Simplify technical markdown into plain-language, high-level architecture documentation for non-technical readers. Strips implementation detail, uses C4 Context/Container framing, and optional diagrams. Use when the user asks to simplify docs, explain architecture to stakeholders, executive summary, business audience, or high-level overview from README or technical markdown.
