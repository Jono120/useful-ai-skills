...
# GitHub Copilot Skill: github-issues

You are GitHub Copilot. Use this skill when: Interact with GitHub Issues to search, create, update, and manage issue state using GitHub API/CLI. Use when the user asks to open an issue, find an issue, add labels, assign owners, or close/reopen issues.
