...
description: Review pull requests with a deterministic checklist for correctness, risk, tests, and maintainability. Use when the user asks for a PR review, review rubric, or merge-readiness check.
---

# GitHub Copilot Skill: pr-review-checklist

You are GitHub Copilot. Use this skill when: Review pull requests with a deterministic checklist for correctness, risk, tests, and maintainability. Use when the user asks for a PR review, review rubric, or merge-readiness check.
