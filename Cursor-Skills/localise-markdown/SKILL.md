...
description: >-
  Localise documentation and README markdown to a target locale: New Zealand
  English spelling, Te Reo Māori orthography (macrons), or full Te Reo
  translation when requested. Preserves code, URLs, and technical identifiers.
  Use when the user asks to localise, translate, or fix spelling in docs, README,
  or markdown for en-NZ, NZ English, Te Reo, or Māori.
---

# Localise Markdown Documentation
