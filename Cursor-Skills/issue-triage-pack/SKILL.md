...
description: >-
  Triage new work into consistent issue templates for bugs, features, tech debt,
  and incident follow-ups. Use when the user asks to write, normalize, or
  improve issue quality before backlog intake.
---
