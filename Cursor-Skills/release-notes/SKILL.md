...
name: release-notes
description: >-
  Generate release notes from git history, pull requests, and changelog inputs
  using a consistent publish-ready format. Use when the user asks for release
  notes, changelog summaries, or version announcement drafts.
---
